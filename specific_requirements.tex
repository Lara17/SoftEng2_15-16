\section{Specific requirements}
	\subsection{External interface requirements}
		...
		\subsubsection{User iInterfaces: Mobile Application}
		\paragraph{Home Page}
		\begin{center}
		    \includegraphics[width=0.35\textwidth]{./images/TELEFONO1User}
		\end{center}
		\paragraph{Booking}
		\begin{center}
		...
		\begin{center}
		    \includegraphics[width=0.35\textwidth]{./images/TELEFONO5}
		\end{center}
		...
		\begin{center}
		    \includegraphics[width=0.35\textwidth]{./images/TELEFONO7}
		\end{center}
...
\includegraphics[width=0.60\textwidth]{./images/UseCaseTaxiNotYetRegistered.png}~
 ...
 \textbf{Exit Condition} &  \parbox{0.7\textwidth}{The system adds the new taxi driver to the database and it grants him access to the application.} \\ \hline
