\section{Specific requirements}
	...
	\begin{center}
	~\\
\includegraphics[width=0.28\textwidth]{./images/UseCaseTaxiNotYetRegistered.png}~
	\end{center}
	\begin{tabular}{l l}
...
\paragraph{User side}
	\begin{center}
	~\\
\includegraphics[width=0.28\textwidth]{./images/UseCaseUser.png}~
	\end{center}
...
\paragraph{Taxi side}
	\begin{center}
	~\\
\includegraphics[width=0.28\textwidth]{./images/UseCaseTaxi.png}~
	\end{center}
\subparagraph{Login}
~\\[0.2cm]
\vspace{20pt}
