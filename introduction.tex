\section{Introduction}
	...
	\begin{itemize}
		...
		\item \textbf{Taxi}: taxis work for a taxi company and provide the service to the users by transporting them to their destination; it is an entity, composed by the taxi driver and the car.
